	...
	return (
      ...
      <div>
			...
			<p className="overview-price">
				...
				>
					{'$'}
					{Mock[0].default_price}
					{'.00'}
				</span>
			</p>
			<p className="reduced">REDUCED PRICE!</p>
			<p className="product-description">{Mock[0].description}</p>
      </div>
			<div>
        ...
        <p><strong>Color</strong></p>
          <div className='color-choices'>
            <img className='thumbnail color' src='https://www.colorhexa.com/4f7942.png' />
            <img className='thumbnail color' src='https://www.colorhexa.com/ffa500.png' />
            <img className='thumbnail color' src='https://www.colorhexa.com/cd5c5c.png' />
            <img className='thumbnail color' src='https://www.colorhexa.com/1e90ff.png' />
          </div>
        </div>
